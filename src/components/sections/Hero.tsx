...
import { asset, PDF_URL, ROUTES } from "@/lib/links";
  ...
  return (
    <section className="flex min-h-svh items-center pb-16 pt-32 md:pt-40" id="top">
      <div className="container grid items-center gap-12 lg:grid-cols-[1.06fr_0.8fr] lg:gap-16">
        ...
        {/* The cover carries real Persian text, so it stays perfectly still:
            no 3D tilt or float loop — only a one-shot entrance. */}
        <m.div
        ...
        >
          ...
          <div className="rounded-[22px] border border-input shadow-[0_50px_130px_-30px_rgb(4_10_18_/_0.7),0_0_90px_-30px_rgb(83_214_245_/_0.4)]">
          ...
          <span className="absolute top-[8%] -start-1.5 rounded-full border border-input bg-popover/85 px-3.5 py-2 text-xs font-bold shadow-xl backdrop-blur-md">
            📖 ۳۷ فصل
          </span>
          <span className="absolute top-[46%] -end-1.5 rounded-full border border-input bg-popover/85 px-3.5 py-2 text-xs font-bold shadow-xl backdrop-blur-md">
            ⚡ Actions-first
          </span>
          <span className="absolute bottom-[6%] start-2 rounded-full border border-input bg-popover/85 px-3.5 py-2 text-xs font-bold shadow-xl backdrop-blur-md">
            💙 رایگان
          </span>
        </m.div>
      </div>
